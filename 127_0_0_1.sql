...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2025 at 06:47 AM
...
-- Database: `blog_site`
--
CREATE DATABASE IF NOT EXISTS `blog_site` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `blog_site`;
...
('root', '[{\"db\":\"blog_site\",\"table\":\"posts\"},{\"db\":\"blog_site\",\"table\":\"users\"},{\"db\":\"university\",\"table\":\"student\"}]');
...
('root', '2025-10-08 04:47:12', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"en_GB\"}');
